<div id="header" class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
    <div class="custom-header">
        <a class="" href="{{ url('/') }}">
            <img class="img-logo" src="{{ asset('assets/logo/Logo_LDCC_v1.svg') }}">
        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right custom-dropdown-logout" aria-labelledby="navbarDropdown">
                            <a href="http://sso.ldcc.vn/user/sso/profile" target="_blank" rel="noopener noreferrer">
                                <div class="info-user d-flex">
                                    <img class="img-avatar" src="{{asset('assets/img/avatar_default.png')}}">
...
{{--                                                     document.getElementById('logout-form').submit();" class="fa fa-sign-out" aria-hidden="true"></i>--}}
